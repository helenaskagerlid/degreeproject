    ...
    <>
      <section className="check-old-thoughts-section" ref={oldThoughtsRef}>
        <h2 className="step-nine-heading">
          Step 9 - Check in with those unhelpful thoughts
        </h2>
        <p className="step-nine-text">
          Now the real question is, how do you feel about these unhelpful
          thoughts after seeing your inner critic in some different ehrm...
          situations? Check in and put the value on the slider to where it
          resonates now.
        </p>
